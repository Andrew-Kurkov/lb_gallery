...
<div class="navbar navbar-dark bg-dark shadow-sm">
    <div class="container">
      <a href="/" class="navbar-brand d-flex align-items-center">
        ...
        <a href="/ap"><button type="button" class="btn btn-secondary">
 ...
 <div class="d-md-flex d-sm-flex justify-content-center">
    <div class="col-md-4 col-sm-6 col-xs-12 mt-0">
        <form enctype="multipart/form-data" class="mt-5" method="POST" action="{{ route('add') }}"
         ...
         @csrf
            ...
            <input class="form-control mb-3" type="text" placeholder="Meme name" name="pic_name" required>
            <input class="form-control mb-3" type="text" placeholder="Author" name="pic_author" required>
            <!-- <input class="form-control mb-3" type="text" placeholder="Creation date" name="pic_date" required> -->
